...
def parse_args():
    ...
    parser.add_argument('--sketch_model', type=str, default='sketch_transformer', choices=['vit', 'lstm', 'sdgraph', 'sketch_transformer', 'gru'], help='草图Encoder的名字')
    ...
    parser.add_argument('--add_str', type=str, default='', help='附带的字符串')
