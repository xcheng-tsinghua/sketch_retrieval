...
def parse_args():
    ...
    parser.add_argument('--root_local', type=str, default=r'D:\document\DeepLearning\DataSet\sketch_retrieval\sketchy')  # r'D:\document\DeepLearning\DataSet\sketch_retrieval\sketchy'
