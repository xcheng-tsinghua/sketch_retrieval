...
class QMULDataset(Dataset):
    ...
    """
    def __init__(self,
                 root=r'D:\document\DeepLearning\DataSet\sketch_retrieval\SketchX_Shoe_ChairV2',
    ...
    def __getitem__(self, idx):
        ...
        Returns:
            ...
            category_name: 类别名称
        """
        sketch_path, image_path = self.data_pairs[idx]
